...
public class ArabicStemmer{
    ...
    static String  pathToStemmerFiles = "C:/Users/Madiha/Documents/NetBeansProjects/stemmer_test/StemmerFiles";
    ...
    private static String isThreeLetters ( String word )
    {
        ...
        if ( root.length ( ) == 3 )
        {
            ...
            //System.out.println("possibleRoots[number][1]="+possibleRoots[0][0]);
